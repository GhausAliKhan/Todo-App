...
**Todo App** is a tool that helps to organize your day. It simply lists the things that you need to do and allows you to mark them as complete. I will build a simple website that allows for doing that, and I will do it using ES6 and Webpack!
...
- **Landing Page for Todo List**
- **Fast access to your Daily Tasks**
...
In order to run this project you need: To clone and run it in a browser
...
```sh
  cd my-folder
  git clone https://github.com/GhausAliKhan/Todo-App.git
  cd Todo-App
```
